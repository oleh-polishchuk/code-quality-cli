...
const init = async ({ dryRun }) => {
    ...
    series.task({
        ...
        fn: async () => {
            ...
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): run npm install"');
        }
    });
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): apply existing prettier rules"');
        },
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): remove prettier package"');
        },
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): remove deprecated @types/prettier package"');
        },
    ...
    series.task({
        ...
        fn: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): upgrade prettier package to v3.0.3"');
        }
    });
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            await promisify(exec)('npm run format:write');
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): apply existing prettier rules after upgrade"');
        },
    ...
    series.task({
        ...
        fn: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): add @fashioncloud/prettier-config package"');
        }
    });
    ...
    series.task({
        ...
        fn: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): create prettier config"');
        }
    });
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): update package.json scripts"');
        },
        fnWhenFalse: async () => {
            let packageJson = JSON.parse(await promisify(fs.readFile)(packageJsonPath, 'utf8'));
            packageJson.scripts['format:check'] = 'prettier --config ./.prettierrc.js \"./app/**/*.ts\" \"./tests/**/*.ts\"';
            ...
            await promisify(fs.writeFile)('./package.json', JSON.stringify(packageJson, null, 2) + os.EOL);
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): create package.json scripts"');
        }
    })
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): update prettier ignore file"');
        },
        fnWhenFalse: async () => {
            await promisify(fs.cp)(prettierIgnoreFromPath, prettierIgnoreToPath);
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): create prettier ignore file"');
        }
    });
    ...
    series.task({
        ...
        fn: async () => {
            await promisify(exec)('npm run format:write');
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): apply existing prettier rules after update"');
        }
    });
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): install husky and lint-staged"');
        }
    });
    ...
    series.task({
        ...
        fn: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): initialize husky and lint-staged"');
        }
    });
    ...
    series.conditionalTask({
        ...
        fnWhenTrue: async () => {
            ...
            await promisify(exec)('git add .');
            await promisify(exec)('git diff-index --quiet HEAD || git commit -m "style(prettier): create pre-commit hook"');
        },
